...
"""autogenerated by genpy from pos_control/DoPositionControlAction.msg. Do not edit."""
import codecs
import sys
...
class DoPositionControlAction(genpy.Message):
  _md5sum = "f01a5aec9b769b504f5e3e76381fda1c"
  _type = "pos_control/DoPositionControlAction"
...
"""
  ...
  _slot_types = ['pos_control/DoPositionControlActionGoal','pos_control/DoPositionControlActionResult','pos_control/DoPositionControlActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoPositionControlAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pos_control.msg.DoPositionControlActionGoal()
      if self.action_result is None:
        self.action_result = pos_control.msg.DoPositionControlActionResult()
      if self.action_feedback is None:
        self.action_feedback = pos_control.msg.DoPositionControlActionFeedback()
    else:
      self.action_goal = pos_control.msg.DoPositionControlActionGoal()
      self.action_result = pos_control.msg.DoPositionControlActionResult()
      self.action_feedback = pos_control.msg.DoPositionControlActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.p_d)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.p_d))
      _x = self
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_result.result.p_i)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_result.result.p_i))
      _x = self
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_feedback.feedback.p_e)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_feedback.feedback.p_e))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.p_d = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_result.result.p_i = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_feedback.feedback.p_e = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.p_d.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_result.result.p_i.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      _x = self.action_feedback.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_feedback.feedback.p_e.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.p_d = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      self.action_result.result.p_i = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      self.action_feedback.feedback.p_e = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
